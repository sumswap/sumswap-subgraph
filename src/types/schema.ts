...
export class SumswapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save SumswapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save SumswapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("SumswapFactory", id.toString(), this);
  }

  static load(id: string): SumswapFactory | null {
    return store.get("SumswapFactory", id) as SumswapFactory | null;
  }
...
export class SumswapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save SumswapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save SumswapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("SumswapDayData", id.toString(), this);
  }

  static load(id: string): SumswapDayData | null {
    return store.get("SumswapDayData", id) as SumswapDayData | null;
  }
